...
import './createBidding3.dart';

class CreateBidding2 extends StatefulWidget {
  @override
  _CreateBidding2State createState() => _CreateBidding2State();
}

class _CreateBidding2State extends State<CreateBidding2> {
              ...
              onTap: () {
                setState(() {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => CreateBidding3()));
                });
              },
              child: Container(
                alignment: Alignment.center,
