...
import './createBidding2.dart';

class CreateBidding1 extends StatefulWidget {
  @override
  _CreateBidding1State createState() => _CreateBidding1State();
}

class _CreateBidding1State extends State<CreateBidding1> {
  var item = 'Item';
        ...
        child: ListView(
          children: <Widget>[
            ...
            GestureDetector(
              onTap: () {
                setState(() {
                  Navigator.push(context, MaterialPageRoute(builder: (context)=> CreateBidding2()));
                });
              },
              child: Container(
                alignment: Alignment.center,
